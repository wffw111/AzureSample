+(function () {
    ...
    var mainModule = angular.module('unitTestApp',[]);
    mainModule.controller('defaultCtrl', ['$scope', '$http', '$interval', '$timeout', '$log',
    ...
    mainModule.filter("labelCase", function () {
    ...
    mainModule.directive('unorderedList', function () {
    ...
    mainModule.factory("counterService", function () {
        var counter = 0;
        return {
